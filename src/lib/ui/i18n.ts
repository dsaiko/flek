...
const STRINGS = {
  ...
  patternBarevna: { cs: 'Moderní barevná', en: 'Modern coloured', de: 'Modern farbig', fr: 'Moderne colorée' },
  patternLidova: { cs: 'Moderní lidová', en: 'Modern folk', de: 'Modern volkstümlich', fr: 'Moderne populaire' },
  ...
  reportBug: { cs: 'Nahlásit chybu', en: 'Report a bug', de: 'Fehler melden', fr: 'Signaler un bug' },
