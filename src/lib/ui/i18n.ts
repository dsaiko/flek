...
const STRINGS = {
  ...
  voleny: { cs: 'Volený mariáš (FLEK!)', en: 'Chosen mariáš (FLEK!)' },
  licitovany: { cs: 'Licitovaný mariáš (RE!)', en: 'Auction mariáš (RE!)' },
  ...
  history: { cs: 'Historický (1860)', en: 'Historical (1860)' },
